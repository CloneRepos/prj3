@ST_106352 @tagtagtag @this_is_story_tag
...
@SC_457759 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457760 @third_scenario_tag
...
@SC_457761 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457762 @fifth_scenario_tag
