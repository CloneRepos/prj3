@ST_41852 @tagtagtag @this_is_story_tag
...
@SC_205451 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205452 @third_scenario_tag
...
@SC_205453 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205454 @fifth_scenario_tag
