@ST_87882 @tagtagtag @this_is_story_tag
...
@SC_386342 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386343 @third_scenario_tag
...
@SC_386344 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386345 @fifth_scenario_tag
