@ST_37782 @tagtagtag @this_is_story_tag
...
@SC_187289 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187290 @third_scenario_tag
...
@SC_187291 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187292 @fifth_scenario_tag
