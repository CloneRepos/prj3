@ST_116490 @tagtagtag @this_is_story_tag
...
@SC_496847 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496848 @third_scenario_tag
...
@SC_496849 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496850 @fifth_scenario_tag
