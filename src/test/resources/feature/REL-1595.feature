@ST_77741 @tagtagtag @this_is_story_tag
...
@SC_345707 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345708 @third_scenario_tag
...
@SC_345709 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345710 @fifth_scenario_tag
