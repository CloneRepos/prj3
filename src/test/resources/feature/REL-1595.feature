@ST_108863 @tagtagtag @this_is_story_tag
...
@SC_467215 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467216 @third_scenario_tag
...
@SC_467217 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467218 @fifth_scenario_tag
