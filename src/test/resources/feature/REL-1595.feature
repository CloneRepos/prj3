@ST_98733 @tagtagtag @this_is_story_tag
...
@SC_428670 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428671 @third_scenario_tag
...
@SC_428672 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428673 @fifth_scenario_tag
