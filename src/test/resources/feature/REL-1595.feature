@ST_65482 @tagtagtag @this_is_story_tag
...
@SC_297102 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297103 @third_scenario_tag
...
@SC_297104 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297105 @fifth_scenario_tag
