@ST_121177 @tagtagtag @this_is_story_tag
...
@SC_515286 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515287 @third_scenario_tag
...
@SC_515288 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515289 @fifth_scenario_tag
