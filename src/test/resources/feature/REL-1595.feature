@ST_11118 @tagtagtag @this_is_story_tag
...
@SC_73134 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73135 @third_scenario_tag
...
@SC_73136 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73137 @fifth_scenario_tag
