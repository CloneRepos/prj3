@ST_32149 @tagtagtag @this_is_story_tag
...
@SC_168846 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168847 @third_scenario_tag
...
@SC_168848 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168849 @fifth_scenario_tag
