@ST_33600 @tagtagtag @this_is_story_tag
...
@SC_174014 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174015 @third_scenario_tag
...
@SC_174016 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174017 @fifth_scenario_tag
