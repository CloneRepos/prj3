@ST_120656 @tagtagtag @this_is_story_tag
...
@SC_513237 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513238 @third_scenario_tag
...
@SC_513239 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513240 @fifth_scenario_tag
