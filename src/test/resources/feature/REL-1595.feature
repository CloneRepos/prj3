@ST_61644 @tagtagtag @this_is_story_tag
...
@SC_282796 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282797 @third_scenario_tag
...
@SC_282798 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282799 @fifth_scenario_tag
