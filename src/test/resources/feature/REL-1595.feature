@ST_36938 @tagtagtag @this_is_story_tag
...
@SC_184767 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184768 @third_scenario_tag
...
@SC_184769 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184770 @fifth_scenario_tag
