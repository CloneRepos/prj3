@ST_88522 @tagtagtag @this_is_story_tag
...
@SC_389447 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389448 @third_scenario_tag
...
@SC_389449 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389450 @fifth_scenario_tag
