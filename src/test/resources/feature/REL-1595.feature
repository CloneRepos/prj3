@ST_118052 @tagtagtag @this_is_story_tag
...
@SC_502993 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502994 @third_scenario_tag
...
@SC_502995 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502996 @fifth_scenario_tag
