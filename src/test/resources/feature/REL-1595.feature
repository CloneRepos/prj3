@ST_104977 @tagtagtag @this_is_story_tag
...
@SC_453190 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_453191 @third_scenario_tag
...
@SC_453192 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_453193 @fifth_scenario_tag
