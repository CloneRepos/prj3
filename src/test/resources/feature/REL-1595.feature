@ST_49287 @tagtagtag @this_is_story_tag
...
@SC_234738 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234739 @third_scenario_tag
...
@SC_234740 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234741 @fifth_scenario_tag
