@ST_69129 @tagtagtag @this_is_story_tag
...
@SC_312658 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312659 @third_scenario_tag
...
@SC_312660 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312661 @fifth_scenario_tag
