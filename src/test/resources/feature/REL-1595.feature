@ST_70075 @tagtagtag @this_is_story_tag
...
@SC_316718 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316719 @third_scenario_tag
...
@SC_316720 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316721 @fifth_scenario_tag
