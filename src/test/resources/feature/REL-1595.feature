@ST_17174 @tagtagtag @this_is_story_tag
...
@SC_108395 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108396 @third_scenario_tag
...
@SC_108397 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108398 @fifth_scenario_tag
