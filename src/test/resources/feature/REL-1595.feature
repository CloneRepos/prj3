@ST_117011 @tagtagtag @this_is_story_tag
...
@SC_498896 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498897 @third_scenario_tag
...
@SC_498898 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498899 @fifth_scenario_tag
