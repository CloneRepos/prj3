@ST_109384 @tagtagtag @this_is_story_tag
...
@SC_469264 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469265 @third_scenario_tag
...
@SC_469266 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469267 @fifth_scenario_tag
