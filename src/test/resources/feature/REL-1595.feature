@ST_30345 @tagtagtag @this_is_story_tag
...
@SC_160687 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160688 @third_scenario_tag
...
@SC_160689 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160690 @fifth_scenario_tag
