@ST_50410 @tagtagtag @this_is_story_tag
...
@SC_238731 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238732 @third_scenario_tag
...
@SC_238733 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238734 @fifth_scenario_tag
