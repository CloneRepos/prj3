@ST_47636 @tagtagtag @this_is_story_tag
...
@SC_228639 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228640 @third_scenario_tag
...
@SC_228641 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228642 @fifth_scenario_tag
