@ST_99254 @tagtagtag @this_is_story_tag
...
@SC_430719 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430720 @third_scenario_tag
...
@SC_430721 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430722 @fifth_scenario_tag
