@ST_34891 @tagtagtag @this_is_story_tag
...
@SC_178718 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178719 @third_scenario_tag
...
@SC_178720 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178721 @fifth_scenario_tag
