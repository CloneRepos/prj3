@ST_32703 @tagtagtag @this_is_story_tag
...
@SC_171248 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171249 @third_scenario_tag
...
@SC_171250 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171251 @fifth_scenario_tag
