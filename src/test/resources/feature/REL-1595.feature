@ST_78951 @tagtagtag @this_is_story_tag
...
@SC_350613 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350614 @third_scenario_tag
...
@SC_350615 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350616 @fifth_scenario_tag
