@ST_115448 @tagtagtag @this_is_story_tag
...
@SC_492749 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492750 @third_scenario_tag
...
@SC_492751 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492752 @fifth_scenario_tag
