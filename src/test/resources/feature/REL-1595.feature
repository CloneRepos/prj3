@ST_93197 @tagtagtag @this_is_story_tag
...
@SC_407765 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407766 @third_scenario_tag
...
@SC_407767 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407768 @fifth_scenario_tag
