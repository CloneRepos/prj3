@ST_114406 @tagtagtag @this_is_story_tag
...
@SC_488651 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488652 @third_scenario_tag
...
@SC_488653 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488654 @fifth_scenario_tag
