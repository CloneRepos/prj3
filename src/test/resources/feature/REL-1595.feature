@ST_101337 @tagtagtag @this_is_story_tag
...
@SC_438902 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438903 @third_scenario_tag
...
@SC_438904 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438905 @fifth_scenario_tag
