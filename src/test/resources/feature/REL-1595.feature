@ST_98212 @tagtagtag @this_is_story_tag
...
@SC_426621 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426622 @third_scenario_tag
...
@SC_426623 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426624 @fifth_scenario_tag
