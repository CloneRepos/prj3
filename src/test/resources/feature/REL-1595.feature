@ST_47209 @tagtagtag @this_is_story_tag
...
@SC_227380 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227381 @third_scenario_tag
...
@SC_227382 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227383 @fifth_scenario_tag
