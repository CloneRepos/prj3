@ST_82089 @tagtagtag @this_is_story_tag
...
@SC_362421 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362422 @third_scenario_tag
...
@SC_362423 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362424 @fifth_scenario_tag
