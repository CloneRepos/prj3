@ST_11772 @tagtagtag @this_is_story_tag
...
@SC_78242 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78243 @third_scenario_tag
...
@SC_78244 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78245 @fifth_scenario_tag
