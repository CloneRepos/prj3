@ST_57368 @tagtagtag @this_is_story_tag
...
@SC_267375 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267376 @third_scenario_tag
...
@SC_267377 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267378 @fifth_scenario_tag
