@ST_48157 @tagtagtag @this_is_story_tag
...
@SC_230689 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230690 @third_scenario_tag
...
@SC_230691 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230692 @fifth_scenario_tag
