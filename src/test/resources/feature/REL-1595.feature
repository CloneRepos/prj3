@ST_92155 @tagtagtag @this_is_story_tag
...
@SC_403667 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403668 @third_scenario_tag
...
@SC_403669 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403670 @fifth_scenario_tag
