@ST_72030 @tagtagtag @this_is_story_tag
...
@SC_323915 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323916 @third_scenario_tag
...
@SC_323917 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323918 @fifth_scenario_tag
