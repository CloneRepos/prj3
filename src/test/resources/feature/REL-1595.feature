@ST_96128 @tagtagtag @this_is_story_tag
...
@SC_418425 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418426 @third_scenario_tag
...
@SC_418427 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418428 @fifth_scenario_tag
