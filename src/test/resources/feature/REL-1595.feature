@ST_49731 @tagtagtag @this_is_story_tag
...
@SC_236531 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236532 @third_scenario_tag
...
@SC_236533 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236534 @fifth_scenario_tag
