@ST_37360 @tagtagtag @this_is_story_tag
...
@SC_186027 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186028 @third_scenario_tag
...
@SC_186029 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186030 @fifth_scenario_tag
