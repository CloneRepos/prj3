@ST_45909 @tagtagtag @this_is_story_tag
...
@SC_222692 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222693 @third_scenario_tag
...
@SC_222694 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222695 @fifth_scenario_tag
