@ST_45335 @tagtagtag @this_is_story_tag
...
@SC_220147 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220148 @third_scenario_tag
...
@SC_220149 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220150 @fifth_scenario_tag
