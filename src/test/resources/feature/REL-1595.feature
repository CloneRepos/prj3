@ST_123254 @tagtagtag @this_is_story_tag
...
@SC_523426 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523427 @third_scenario_tag
...
@SC_523428 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523429 @fifth_scenario_tag
