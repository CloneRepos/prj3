@ST_72558 @tagtagtag @this_is_story_tag
...
@SC_326020 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326021 @third_scenario_tag
...
@SC_326022 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326023 @fifth_scenario_tag
