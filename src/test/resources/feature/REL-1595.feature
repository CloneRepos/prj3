@ST_41106 @tagtagtag @this_is_story_tag
...
@SC_201991 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201992 @third_scenario_tag
...
@SC_201993 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201994 @fifth_scenario_tag
