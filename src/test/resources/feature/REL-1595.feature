@ST_33164 @tagtagtag @this_is_story_tag
...
@SC_172711 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_172712 @third_scenario_tag
...
@SC_172713 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_172714 @fifth_scenario_tag
