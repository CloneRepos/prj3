@ST_73701 @tagtagtag @this_is_story_tag
...
@SC_330224 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330225 @third_scenario_tag
...
@SC_330226 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330227 @fifth_scenario_tag
