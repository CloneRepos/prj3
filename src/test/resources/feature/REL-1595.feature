@ST_77314 @tagtagtag @this_is_story_tag
...
@SC_344443 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344444 @third_scenario_tag
...
@SC_344445 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344446 @fifth_scenario_tag
