@ST_80064 @tagtagtag @this_is_story_tag
...
@SC_354649 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354650 @third_scenario_tag
...
@SC_354651 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354652 @fifth_scenario_tag
