@ST_57790 @tagtagtag @this_is_story_tag
...
@SC_268634 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268635 @third_scenario_tag
...
@SC_268636 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268637 @fifth_scenario_tag
