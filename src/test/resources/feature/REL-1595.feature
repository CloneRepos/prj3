@ST_51585 @tagtagtag @this_is_story_tag
...
@SC_244706 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244707 @third_scenario_tag
...
@SC_244708 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244709 @fifth_scenario_tag
