@ST_80491 @tagtagtag @this_is_story_tag
...
@SC_355909 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_355910 @third_scenario_tag
...
@SC_355911 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_355912 @fifth_scenario_tag
