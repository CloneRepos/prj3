@ST_123775 @tagtagtag @this_is_story_tag
...
@SC_525475 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525476 @third_scenario_tag
...
@SC_525477 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525478 @fifth_scenario_tag
