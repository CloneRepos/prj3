@ST_52968 @tagtagtag @this_is_story_tag
...
@SC_251148 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251149 @third_scenario_tag
...
@SC_251150 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251151 @fifth_scenario_tag
