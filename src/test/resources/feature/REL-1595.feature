@ST_111374 @tagtagtag @this_is_story_tag
...
@SC_476671 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476672 @third_scenario_tag
...
@SC_476673 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476674 @fifth_scenario_tag
