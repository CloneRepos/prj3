@ST_64233 @tagtagtag @this_is_story_tag
...
@SC_291719 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291720 @third_scenario_tag
...
@SC_291721 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291722 @fifth_scenario_tag
