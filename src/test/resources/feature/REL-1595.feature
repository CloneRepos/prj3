@ST_56463 @tagtagtag @this_is_story_tag
...
@SC_264220 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264221 @third_scenario_tag
...
@SC_264222 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264223 @fifth_scenario_tag
