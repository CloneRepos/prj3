@ST_42369 @tagtagtag @this_is_story_tag
...
@SC_207464 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207465 @third_scenario_tag
...
@SC_207466 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207467 @fifth_scenario_tag
