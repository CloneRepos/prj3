@ST_89557 @tagtagtag @this_is_story_tag
...
@SC_393490 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393491 @third_scenario_tag
...
@SC_393492 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393493 @fifth_scenario_tag
