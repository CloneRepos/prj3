@ST_12549 @tagtagtag @this_is_story_tag
...
@SC_81603 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81604 @third_scenario_tag
...
@SC_81605 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81606 @fifth_scenario_tag
