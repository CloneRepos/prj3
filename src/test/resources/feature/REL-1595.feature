@ST_74977 @tagtagtag @this_is_story_tag
...
@SC_335625 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335626 @third_scenario_tag
...
@SC_335627 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335628 @fifth_scenario_tag
