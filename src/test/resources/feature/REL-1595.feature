@ST_76189 @tagtagtag @this_is_story_tag
...
@SC_340397 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340398 @third_scenario_tag
...
@SC_340399 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340400 @fifth_scenario_tag
