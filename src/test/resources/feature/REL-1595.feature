@ST_79373 @tagtagtag @this_is_story_tag
...
@SC_351875 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351876 @third_scenario_tag
...
@SC_351877 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351878 @fifth_scenario_tag
