@ST_69231 @tagtagtag @this_is_story_tag
...
@SC_312850 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312851 @third_scenario_tag
...
@SC_312852 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312853 @fifth_scenario_tag
