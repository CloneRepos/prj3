@ST_110332 @tagtagtag @this_is_story_tag
...
@SC_472573 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472574 @third_scenario_tag
...
@SC_472575 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472576 @fifth_scenario_tag
