@ST_96649 @tagtagtag @this_is_story_tag
...
@SC_420474 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420475 @third_scenario_tag
...
@SC_420476 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420477 @fifth_scenario_tag
