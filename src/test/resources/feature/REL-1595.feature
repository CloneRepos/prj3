@ST_75467 @tagtagtag @this_is_story_tag
...
@SC_337389 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337390 @third_scenario_tag
...
@SC_337391 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337392 @fifth_scenario_tag
