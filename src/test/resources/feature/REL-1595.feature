@ST_38359 @tagtagtag @this_is_story_tag
...
@SC_189798 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189799 @third_scenario_tag
...
@SC_189800 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189801 @fifth_scenario_tag
