@ST_42886 @tagtagtag @this_is_story_tag
...
@SC_209550 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_209551 @third_scenario_tag
...
@SC_209552 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_209553 @fifth_scenario_tag
