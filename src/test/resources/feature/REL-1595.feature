@ST_35657 @tagtagtag @this_is_story_tag
...
@SC_180979 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180980 @third_scenario_tag
...
@SC_180981 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180982 @fifth_scenario_tag
