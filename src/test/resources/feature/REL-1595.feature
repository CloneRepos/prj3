@ST_90071 @tagtagtag @this_is_story_tag
...
@SC_395471 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395472 @third_scenario_tag
...
@SC_395473 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395474 @fifth_scenario_tag
