@ST_107300 @tagtagtag @this_is_story_tag
...
@SC_461068 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461069 @third_scenario_tag
...
@SC_461070 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461071 @fifth_scenario_tag
