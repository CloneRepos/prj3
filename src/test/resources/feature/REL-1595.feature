@ST_66338 @tagtagtag @this_is_story_tag
...
@SC_301015 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301016 @third_scenario_tag
...
@SC_301017 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301018 @fifth_scenario_tag
