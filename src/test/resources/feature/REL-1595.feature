@ST_62074 @tagtagtag @this_is_story_tag
...
@SC_284194 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284195 @third_scenario_tag
...
@SC_284196 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284197 @fifth_scenario_tag
