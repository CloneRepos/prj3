@ST_34448 @tagtagtag @this_is_story_tag
...
@SC_177269 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177270 @third_scenario_tag
...
@SC_177271 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177272 @fifth_scenario_tag
