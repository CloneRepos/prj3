@ST_67062 @tagtagtag @this_is_story_tag
...
@SC_304144 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304145 @third_scenario_tag
...
@SC_304146 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304147 @fifth_scenario_tag
