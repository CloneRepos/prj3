@ST_76616 @tagtagtag @this_is_story_tag
...
@SC_341657 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341658 @third_scenario_tag
...
@SC_341659 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341660 @fifth_scenario_tag
