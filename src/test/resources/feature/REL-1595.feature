@ST_81568 @tagtagtag @this_is_story_tag
...
@SC_360372 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360373 @third_scenario_tag
...
@SC_360374 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360375 @fifth_scenario_tag
