@ST_92676 @tagtagtag @this_is_story_tag
...
@SC_405716 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405717 @third_scenario_tag
...
@SC_405718 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405719 @fifth_scenario_tag
