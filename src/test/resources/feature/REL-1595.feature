@ST_56283 @tagtagtag @this_is_story_tag
...
@SC_263896 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263897 @third_scenario_tag
...
@SC_263898 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263899 @fifth_scenario_tag
