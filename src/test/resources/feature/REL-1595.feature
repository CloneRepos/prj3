@ST_94666 @tagtagtag @this_is_story_tag
...
@SC_413123 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413124 @third_scenario_tag
...
@SC_413125 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413126 @fifth_scenario_tag
