@ST_113364 @tagtagtag @this_is_story_tag
...
@SC_484553 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484554 @third_scenario_tag
...
@SC_484555 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484556 @fifth_scenario_tag
