@ST_100296 @tagtagtag @this_is_story_tag
...
@SC_434817 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434818 @third_scenario_tag
...
@SC_434819 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434820 @fifth_scenario_tag
