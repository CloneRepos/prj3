@ST_8902 @tagtagtag @this_is_story_tag
...
@SC_61332 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61333 @third_scenario_tag
...
@SC_61334 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61335 @fifth_scenario_tag
