@ST_52231 @tagtagtag @this_is_story_tag
...
@SC_247840 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247841 @third_scenario_tag
...
@SC_247842 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247843 @fifth_scenario_tag
