@ST_100817 @tagtagtag @this_is_story_tag
...
@SC_436866 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436867 @third_scenario_tag
...
@SC_436868 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436869 @fifth_scenario_tag
