@ST_74259 @tagtagtag @this_is_story_tag
...
@SC_332641 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332642 @third_scenario_tag
...
@SC_332643 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332644 @fifth_scenario_tag
