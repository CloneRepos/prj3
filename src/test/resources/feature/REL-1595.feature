@ST_40162 @tagtagtag @this_is_story_tag
...
@SC_198355 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198356 @third_scenario_tag
...
@SC_198357 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198358 @fifth_scenario_tag
