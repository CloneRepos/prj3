@ST_112322 @tagtagtag @this_is_story_tag
...
@SC_480455 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480456 @third_scenario_tag
...
@SC_480457 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480458 @fifth_scenario_tag
