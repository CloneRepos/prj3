@ST_122733 @tagtagtag @this_is_story_tag
...
@SC_521377 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521378 @third_scenario_tag
...
@SC_521379 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521380 @fifth_scenario_tag
