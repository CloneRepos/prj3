@ST_35235 @tagtagtag @this_is_story_tag
...
@SC_179719 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179720 @third_scenario_tag
...
@SC_179721 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179722 @fifth_scenario_tag
