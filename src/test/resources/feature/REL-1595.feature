@ST_83419 @tagtagtag @this_is_story_tag
...
@SC_367762 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367763 @third_scenario_tag
...
@SC_367764 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367765 @fifth_scenario_tag
