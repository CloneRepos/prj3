@ST_83947 @tagtagtag @this_is_story_tag
...
@SC_369867 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369868 @third_scenario_tag
...
@SC_369869 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369870 @fifth_scenario_tag
