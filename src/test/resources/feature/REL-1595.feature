@ST_36089 @tagtagtag @this_is_story_tag
...
@SC_182243 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182244 @third_scenario_tag
...
@SC_182245 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182246 @fifth_scenario_tag
