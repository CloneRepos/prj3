@ST_46614 @tagtagtag @this_is_story_tag
...
@SC_225490 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225491 @third_scenario_tag
...
@SC_225492 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225493 @fifth_scenario_tag
