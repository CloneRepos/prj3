@ST_39715 @tagtagtag @this_is_story_tag
...
@SC_196886 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196887 @third_scenario_tag
...
@SC_196888 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196889 @fifth_scenario_tag
