@ST_118573 @tagtagtag @this_is_story_tag
...
@SC_505042 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505043 @third_scenario_tag
...
@SC_505044 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505045 @fifth_scenario_tag
