@ST_106779 @tagtagtag @this_is_story_tag
...
@SC_459019 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_459020 @third_scenario_tag
...
@SC_459021 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_459022 @fifth_scenario_tag
