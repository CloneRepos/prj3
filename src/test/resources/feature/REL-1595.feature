@ST_93718 @tagtagtag @this_is_story_tag
...
@SC_409814 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409815 @third_scenario_tag
...
@SC_409816 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409817 @fifth_scenario_tag
