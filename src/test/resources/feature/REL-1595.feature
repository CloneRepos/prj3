@ST_119614 @tagtagtag @this_is_story_tag
...
@SC_509139 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509140 @third_scenario_tag
...
@SC_509141 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509142 @fifth_scenario_tag
