@ST_99775 @tagtagtag @this_is_story_tag
...
@SC_432768 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432769 @third_scenario_tag
...
@SC_432770 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432771 @fifth_scenario_tag
