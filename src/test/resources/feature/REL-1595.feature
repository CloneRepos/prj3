@ST_97691 @tagtagtag @this_is_story_tag
...
@SC_424572 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424573 @third_scenario_tag
...
@SC_424574 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424575 @fifth_scenario_tag
