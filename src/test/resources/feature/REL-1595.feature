@ST_117531 @tagtagtag @this_is_story_tag
...
@SC_500944 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_500945 @third_scenario_tag
...
@SC_500946 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_500947 @fifth_scenario_tag
