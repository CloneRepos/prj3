@ST_82617 @tagtagtag @this_is_story_tag
...
@SC_364526 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364527 @third_scenario_tag
...
@SC_364528 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364529 @fifth_scenario_tag
