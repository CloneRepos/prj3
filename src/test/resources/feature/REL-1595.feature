@ST_44139 @tagtagtag @this_is_story_tag
...
@SC_214604 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214605 @third_scenario_tag
...
@SC_214606 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214607 @fifth_scenario_tag
