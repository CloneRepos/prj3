@ST_84578 @tagtagtag @this_is_story_tag
...
@SC_372946 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372947 @third_scenario_tag
...
@SC_372948 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372949 @fifth_scenario_tag
