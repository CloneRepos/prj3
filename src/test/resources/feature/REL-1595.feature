@ST_91634 @tagtagtag @this_is_story_tag
...
@SC_401618 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401619 @third_scenario_tag
...
@SC_401620 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401621 @fifth_scenario_tag
