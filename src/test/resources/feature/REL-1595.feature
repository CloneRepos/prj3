@ST_97170 @tagtagtag @this_is_story_tag
...
@SC_422523 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422524 @third_scenario_tag
...
@SC_422525 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422526 @fifth_scenario_tag
