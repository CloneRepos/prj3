@ST_56867 @tagtagtag @this_is_story_tag
...
@SC_265364 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265365 @third_scenario_tag
...
@SC_265366 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265367 @fifth_scenario_tag
