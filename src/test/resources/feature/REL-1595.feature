@ST_94145 @tagtagtag @this_is_story_tag
...
@SC_411074 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411075 @third_scenario_tag
...
@SC_411076 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411077 @fifth_scenario_tag
