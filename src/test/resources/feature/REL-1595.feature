@ST_63806 @tagtagtag @this_is_story_tag
...
@SC_290459 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290460 @third_scenario_tag
...
@SC_290461 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290462 @fifth_scenario_tag
