@ST_78258 @tagtagtag @this_is_story_tag
...
@SC_347792 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347793 @third_scenario_tag
...
@SC_347794 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347795 @fifth_scenario_tag
