@ST_109905 @tagtagtag @this_is_story_tag
...
@SC_471313 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471314 @third_scenario_tag
...
@SC_471315 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471316 @fifth_scenario_tag
