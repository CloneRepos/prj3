@ST_63127 @tagtagtag @this_is_story_tag
...
@SC_288260 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288261 @third_scenario_tag
...
@SC_288262 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288263 @fifth_scenario_tag
