@ST_36516 @tagtagtag @this_is_story_tag
...
@SC_183505 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183506 @third_scenario_tag
...
@SC_183507 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183508 @fifth_scenario_tag
