@ST_121691 @tagtagtag @this_is_story_tag
...
@SC_517279 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517280 @third_scenario_tag
...
@SC_517281 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517282 @fifth_scenario_tag
