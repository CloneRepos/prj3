@ST_62532 @tagtagtag @this_is_story_tag
...
@SC_286374 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286375 @third_scenario_tag
...
@SC_286376 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286377 @fifth_scenario_tag
