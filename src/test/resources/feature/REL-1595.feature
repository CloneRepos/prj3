@ST_48781 @tagtagtag @this_is_story_tag
...
@SC_233166 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233167 @third_scenario_tag
...
@SC_233168 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233169 @fifth_scenario_tag
